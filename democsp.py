...
if st.session_state.logged_in:
    ...
    if selected == 'About Us':
        ...
        st.write("**Dr. J. Jane Rubel Angelina, Kalasalingam Academy of Research and Education, CSE**")

        # Project Reviwer
        st.markdown("<h3><i class='fas fa-pen'></i> Project Reviwer:</h3>", unsafe_allow_html=True)
        st.write("**Dr.S.shargunam, Kalasalingam Academy of Research and Education, CSE**")
